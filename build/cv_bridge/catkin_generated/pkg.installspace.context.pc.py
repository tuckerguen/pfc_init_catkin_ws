...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lcv_bridge;/usr/local/lib/libopencv_core.so.3.2.0;/usr/local/lib/libopencv_imgproc.so.3.2.0;/usr/local/lib/libopencv_imgcodecs.so.3.2.0".split(';') if "-lcv_bridge;/usr/local/lib/libopencv_core.so.3.2.0;/usr/local/lib/libopencv_imgproc.so.3.2.0;/usr/local/lib/libopencv_imgcodecs.so.3.2.0" != "" else []
